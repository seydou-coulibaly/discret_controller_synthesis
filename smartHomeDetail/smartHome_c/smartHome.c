...
void SmartHome__smartHome_step(int presenceMaison, int presenceAscenseur,
  ...
  int v_140;
  SmartHome_controller__st_14 v_139;
  int v_138;
  int v_137;
  int v_136;
  int v_147;
  SmartHome_controller__st_14 v_146;
  int v_145;
  int v_144;
  int v_143;
  int v_142;
  int v_141;
  int v_151;
  SmartHome_controller__st_14 v_150;
  int v_149;
  int v_148;
  ...
  int v_157;
  SmartHome_controller__st_12 v_156;
  int v_155;
  int v_154;
  int v_153;
  int v_164;
  SmartHome_controller__st_12 v_163;
  int v_162;
  int v_161;
  int v_160;
  int v_159;
  int v_158;
  int v_168;
  SmartHome_controller__st_12 v_167;
  int v_166;
  int v_165;
  ...
  int v_172;
  int v_171;
  SmartHome_controller__st_10 v_170;
  int v_169;
  int v_177;
  int v_176;
  SmartHome_controller__st_10 v_175;
  int v_174;
  int v_185;
  int v_184;
  SmartHome_controller__st_10 v_183;
  int v_182;
  SmartHome_controller__st_10 v_181;
  int v_180;
  int v_179;
  ...
  v_92 = (v_90&&v_91);
  v_93 = !(v_92);
  v_95 = (vent&&luminosite);
  v_96 = !(v_95);
  v_98 = !(luminosite);
  v_99 = (vent&&v_98);
  v_100 = !(v_99);
  v_102 = !(vent);
  v_103 = (v_102&&luminosite);
  v_108 = !(vent);
  v_109 = (v_108&&luminosite);
  v_112 = !(vent);
  v_113 = (v_112&&luminosite);
  v_114 = !(v_113);
  v_123 = !(vent);
  v_125 = !(luminosite);
  ...
  v_104 = !(loccuperMaison);
  v_105 = (v_103&&v_104);
  v_106 = !(v_105);
  v_110 = (v_109&&loccuperMaison);
  v_111 = !(v_110);
  v_126 = !(loccuperMaison);
  ...
  switch (self->ck_23) {
    case SmartHome_controller__St_14_Arriere:
      ...
      v_138 = (v_136&&v_137);
      if (v_138) {
        v_139 = SmartHome_controller__St_14_Idle;
      } else {
        v_139 = SmartHome_controller__St_14_Arriere;
      };
      if (entree) {
        s_5_St_14_Arriere = SmartHome_controller__St_14_Avant;
      } else {
        s_5_St_14_Arriere = v_139;
      };
      if (v_138) {
        v_140 = true;
      } else {
    ...
    case SmartHome_controller__St_14_Avant:
      ...
      v_145 = (sortie&&v_144);
      if (v_145) {
        v_146 = SmartHome_controller__St_14_Arriere;
      } else {
        v_146 = SmartHome_controller__St_14_Avant;
      };
      if (v_143) {
        s_5_St_14_Avant = SmartHome_controller__St_14_Idle;
      } else {
        s_5_St_14_Avant = v_146;
      };
      if (v_145) {
        v_147 = true;
      } else {
    ...
    case SmartHome_controller__St_14_Idle:
      ...
      v_149 = (v_148&&sortie);
      if (v_149) {
        v_150 = SmartHome_controller__St_14_Arriere;
      } else {
        v_150 = SmartHome_controller__St_14_Idle;
      };
      if (entree) {
        s_5_St_14_Idle = SmartHome_controller__St_14_Avant;
      } else {
        s_5_St_14_Idle = v_150;
      };
      s_5 = s_5_St_14_Idle;
      if (v_149) {
        v_151 = true;
  ...
  v_79 = (lpositionDevantPorte==SmartHome_controller__Avant);
  v_80 = (codePorte&&v_79);
  v_81 = !(v_80);
  v_83 = (lpositionDevantPorte==SmartHome_controller__Null);
  v_84 = !(v_83);
  v_87 = (lpositionDevantPorte==SmartHome_controller__Arriere);
  v_88 = !(v_87);
  switch (self->ck_27) {
    case SmartHome_controller__St_12_Arriere:
      ...
      v_155 = (v_153&&v_154);
      if (v_155) {
        v_156 = SmartHome_controller__St_12_Idle;
      } else {
        v_156 = SmartHome_controller__St_12_Arriere;
      };
      if (entree_1) {
        s_3_St_12_Arriere = SmartHome_controller__St_12_Avant;
      } else {
        s_3_St_12_Arriere = v_156;
      };
      if (v_155) {
        v_157 = true;
      } else {
    ...
    case SmartHome_controller__St_12_Avant:
      ...
      v_160 = (v_158&&v_159);
      v_161 = !(entree_1);
      v_162 = (sortie_1&&v_161);
      if (v_162) {
        v_163 = SmartHome_controller__St_12_Arriere;
      } else {
        v_163 = SmartHome_controller__St_12_Avant;
      };
      if (v_160) {
        s_3_St_12_Avant = SmartHome_controller__St_12_Idle;
      } else {
        s_3_St_12_Avant = v_163;
      };
      if (v_162) {
        v_164 = true;
      } else {
    ...
    case SmartHome_controller__St_12_Idle:
      v_165 = !(entree_1);
      v_166 = (v_165&&sortie_1);
      if (v_166) {
        v_167 = SmartHome_controller__St_12_Arriere;
      } else {
        v_167 = SmartHome_controller__St_12_Idle;
      };
      if (entree_1) {
        s_3_St_12_Idle = SmartHome_controller__St_12_Avant;
      } else {
        s_3_St_12_Idle = v_167;
      };
      s_3 = s_3_St_12_Idle;
      if (v_166) {
        v_168 = true;
  ...
  v_68 = (lpositionDevantBarriere==SmartHome_controller__Avant);
  v_69 = (codeBarriere&&v_68);
  v_70 = !(v_69);
  v_72 = (lpositionDevantBarriere==SmartHome_controller__Null);
  v_73 = !(v_72);
  v_76 = (lpositionDevantBarriere==SmartHome_controller__Arriere);
  v_77 = !(v_76);
  switch (self->ck_31) {
  ...
  SmartHome_controller__smartHome_ctrlr0_step(self->ck, self->ck_11,
                                              ...
                                              luminosite, ok, self->pnr,
                                              self->pnr_1, self->pnr_10,
                                              self->pnr_11, self->pnr_12,
                                              self->pnr_2, self->pnr_3,
                                              self->pnr_4, self->pnr_5,
                                              self->pnr_6, self->pnr_7,
                                              self->pnr_8, self->pnr_9,
                                              presenceAscenseur,
  ...
  marcheArret = SmartHome_controller__smartHome_ctrlr0_out_st.marcheArret;
  ...
  prop11 = (v_115||louvrirPoubelle);
  _out->poubelleOuvert = louvrirPoubelle;
  v_116 = !(louvrirPoubelle);
  prop10 = (lpresencePoubelle||v_116);
  switch (self->ck_21) {
  ...
  v_82 = (louvrirPorte==SmartHome_controller__Ouvert);
  prop16 = (v_81||v_82);
  v_85 = (louvrirPorte==SmartHome_controller__Ouvert);
  v_86 = !(v_85);
  prop23 = (v_84||v_86);
  v_89 = (louvrirPorte==SmartHome_controller__Ouvert);
  prop17 = (v_88||v_89);
  switch (self->ck_25) {
  ...
  v_71 = (louvrirBarriere==SmartHome_controller__Ouvert);
  prop18 = (v_70||v_71);
  v_74 = (louvrirBarriere==SmartHome_controller__Ouvert);
  v_75 = !(v_74);
  prop24 = (v_73||v_75);
  v_78 = (louvrirBarriere==SmartHome_controller__Ouvert);
  prop19 = (v_77||v_78);
  switch (self->ck_29) {
  ...
  lstores = store;
  prop12a = (v_111||lstores);
  prop8 = (lstores||lLumiere);
  v_127 = (lstores||lLumiere);
  prop3 = (v_126||v_127);
  ...
  v_107 = !(lstores);
  prop12b = (v_106||v_107);
  prop12 = (v_114||lstores);
  v_117 = !(lstores);
  prop9 = (v_117||v_118);
  v_119 = !(lstores);
  v_120 = (v_119&&loccuperMaison);
  v_121 = !(v_120);
  prop8a = (v_121||lLumiere);
  v_122 = !(lstores);
  prop7 = (luminosite||v_122);
  v_124 = !(lstores);
  prop6 = (v_123||v_124);
  prop5 = (v_125||lstores);
  prop4 = (vent||lstores);
  v_128 = !(lstores);
  prop2 = (loccuperMaison||v_128);
  v = (prop1&&prop2);
  v_46 = (v&&prop3);
  v_47 = (v_46&&prop8a);
  v_48 = (v_47&&prop9);
  ...
  switch (ck_32) {
    case SmartHome_controller__St_10_Vigilence:
      ...
      if (r_1) {
        ...
        vigilence_St_10_Vigilence = self->v_173;
      };
      ...
      v_169 = (dVigilence_1<=vigilence);
      if (v_169) {
        v_170 = SmartHome_controller__St_10_Arret;
      } else {
        v_170 = SmartHome_controller__St_10_Vigilence;
      };
      if (pbHab) {
        ns_1_St_10_Vigilence = SmartHome_controller__St_10_Sonner;
      } else {
        ns_1_St_10_Vigilence = v_170;
      };
      if (v_169) {
        v_171 = true;
      } else {
    ...
    case SmartHome_controller__St_10_Sonner:
      ...
      if (r_1) {
        ...
        reprise_St_10_Sonner = self->v_178;
      };
      ...
      v_174 = (dReprise_1<=reprise);
      if (v_174) {
        v_175 = SmartHome_controller__St_10_Allume;
      } else {
        v_175 = SmartHome_controller__St_10_Sonner;
      };
      if (code) {
        ns_1_St_10_Sonner = SmartHome_controller__St_10_Arret;
      } else {
        ns_1_St_10_Sonner = v_175;
      };
    ...
    case SmartHome_controller__St_10_Allume:
      ...
      if (r_1) {
        ...
        temps_St_10_Allume = self->v_186;
      };
      sonnerAlarme_St_10_Allume = false;
      enMarche_St_10_Allume = SmartHome_controller__Vert;
      temps = temps_St_10_Allume;
      v_179 = (dVigilence_1<=temps);
      v_180 = (pbGar&&v_179);
      if (v_180) {
        v_181 = SmartHome_controller__St_10_Sonner;
      } else {
        v_181 = SmartHome_controller__St_10_Allume;
      };
      if (pbHab) {
        v_183 = SmartHome_controller__St_10_Sonner;
      } else {
        v_183 = v_181;
      };
      if (code) {
  ...
  v_64 = (lenMarche==SmartHome_controller__Rouge);
  v_65 = !(v_64);
  prop22 = (loccuperMaison||v_65);
  switch (self->ck_33) {
    case SmartHome_controller__St_9_Mouvement:
      v_187 = !(demandeEtage_1);
      v_188 = (v_187||arriveEtage_1);
      if (v_188) {
  ...
  lascenseur = etat;
  prop21 = (v_66||lascenseur);
  _out->ascenseur = lascenseur;
  v_67 = !(lascenseur);
  prop20 = (loccuperAscenseur||v_67);
  v_62 = (v_61&&prop20);
  v_63 = (v_62&&prop21);
  _out->property = (v_63&&prop22);
  self->ck = ns_12;
  self->pnr_12 = nr_12;
  self->ck_11 = ns_11;
  self->pnr_11 = nr_11;
