...
void SmartHome_controller__smartHome_ctrlr0_step(SmartHome_controller__st_21 ck,
  ...
  v_9 = (ck_29==SmartHome_controller__St_11_Fermer);
  v_10 = !(v_9);
  l5 = (v_10||l4);
  _out->copen = l5;
  l6 = !(presenceMaison);
  l7 = (l6||l1);
  v_7 = (ck_29==SmartHome_controller__St_11_Ouvrir);
  v_8 = !(v_7);
  l8 = (v_8||l7);
  _out->close = l8;
  ...
  v_5 = (ck_19==SmartHome_controller__St_16_Fermer);
  v_6 = !(v_5);
  l13 = (v_6||presenceDevantPoubelle);
  _out->con = l13;
  l14 = !(presenceDevantPoubelle);
  v_3 = (ck_19==SmartHome_controller__St_16_Ouvrir);
  v_4 = !(v_3);
  l15 = (v_4||l14);
  _out->coff = l15;
  v_2 = (ck_33==SmartHome_controller__St_9_Mouvement);
