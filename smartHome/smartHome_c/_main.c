...
/* --- Command line: /home/sey/.opam/4.02.3/bin/heptc -hepts -s smartHome -target c -target ctrln smartHome.ept --- */
...
int main(int argc, char** argv) {
  ...
  while ((!(step_max)||(step_c<step_max))) {
    ...
    if ((scanf("%d", &marcheArretAlarme)==EOF)) {
      return 0;
    };;
    ...
    SmartHome__smartHome_step(presenceMaison, presenceAscenseur,
                              ...
                              luminosite, marcheArretAlarme, codeAlarme,
                              codePorte, codeBarriere, presenceEntreePorte,
