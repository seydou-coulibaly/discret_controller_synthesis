...
void SmartHome_controller__smartHome_ctrlr0_step(SmartHome_controller__st_21 ck,
  ...
  v_7 = (ck_29==SmartHome_controller__St_11_Fermer);
  v_8 = !(v_7);
  l5 = (v_8||l4);
  _out->copen = l5;
  l6 = !(presenceMaison);
  l7 = (l6||l1);
  v_5 = (ck_29==SmartHome_controller__St_11_Ouvrir);
  v_6 = !(v_5);
  l8 = (v_6||l7);
  _out->close = l8;
  ...
  v_2 = (ck_19==SmartHome_controller__St_16_Fermer);
  l15 = (v_2||l14);
  _out->coff = l15;
  v_1 = (ck_33==SmartHome_controller__St_9_Mouvement);
  l16 = (v_1||presenceAscenseur);
